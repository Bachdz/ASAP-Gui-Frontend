...
class Main extends Component {
    ...
    showMainScreen = (appName, channel) => {
        console.log(appName, channel);

        let url = 'http://localhost:8080/api/v1/asap/messages?peer=' + this.props.username + '&storage=' + this.props.appName + '&uri=' + channel.uri;
        axios.get(url)
            .then(res => this.setState({ mainscreeninfo: res.data, showMainScreen: true }))
        this.getLog();
    }
