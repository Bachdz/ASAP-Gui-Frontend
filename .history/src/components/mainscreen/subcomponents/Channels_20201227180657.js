...
class Channels extends Component {
    ...
    render() {
        ...
        const channelOnClick = (event, index, appName, channel, showMainScreen) => {
            handleListItemClick(event, index);
            this.props.showMainScreen(appName, channel, showMainScreen);
        }
...

                                {
                                    this.state.channels.length === 0 ?
                                        ...
                                        this.state.channels.map((channel, index) => (
                                            <ListItem selected={selectedIndex === index && deselect === true} className={selectedIndex === index && deselect === true ? classes.setSelected : null} onClick={(event) => { channelOnClick(event, index, this.props.appName, channel, this.state.showMainScreen) }} button id="channels" >
