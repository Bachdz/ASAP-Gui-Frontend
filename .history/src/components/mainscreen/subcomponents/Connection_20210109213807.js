...
class Connection extends Component {
    ...
    doOpenConnection = () => {
        ...
        axios.post(url).then(res => { this.setState({ openedConnection: res.data, showHostInfo: true }) });
    ...
    render() {
        const { openAddConnection, activateAddConnection, alertmsg, alertopen, alerttype, openedConnection } = this.state;
        ...
        return (
            <div className="connection-menu">
                ...
                <div className="hosted-server">
                    <PublicIcon id="icon" />  You are now hosting on {openedConnection.ip} | Port {openedConnection.port}
                </div>
