...
import SockJsClient from 'react-stomp'; import { animateScroll } from "react-scroll";
...
class Messages extends Component {
    ...
    getReceived = () => {
        ...
        axios.get(urlReceived)
            .then(res => this.setState({ received: res.data }, this.scrollToBottom))
    }
        ...
        return (
            <div className="messages-container">
                ...
                <div className="mess">
                    ...
                    <div className="received-content" id="scrollable">
                        <div className="inbox">
