            ...
            <div className="channels-container">
                <List>
                    ...
                    </div>
                    {
                        openAddChannel ?
                            <div className="add">
                                <input autoComplete="off" type="text" id="addApp" name="channelname" className="input" placeholder="Enter channel name" />
                                <input autoComplete="off" type="text" id="recipients" name="recipients" className="input" placeholder="Enter recipients" />

                                {
                                    activateAddApp ?
                                        <CheckIcon id="checkicon-activate" className="icon" onClick={ } />
                                        :
