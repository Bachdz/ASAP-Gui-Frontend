...
class Apps extends Component {
    ...
    render() {
        ...
        const handleListItemClick = (event, index) => {
            ...
            console.log(this.props.apps[index].name)
        ...
        const validate = (e) => {
            ...
            if (e.target.value.length === 0) {
                ...
                this.setState({ activateAddApp: !this.state.activateAddApp, newApp: e.target.value })
            }
        }
            ...
            <div>
                ...
                </List>
                {
                    showChannel ?
                        ...
                        <Channels appName={this.state.appName} username={this.props.username} />
                        :
                        null
