...
class Apps extends Component {
    ...
    render() {
        const { open, openAddApp, activateAddApp, newApp, selectedIndex, showChannel } = this.state;
                            ...
                            <List>

                                {
                                    this.props.apps.map((app, index) => (
                                        <ListItem className={selectedIndex === index ? classes.setSelected : null} onClick={(event) => handleListItemClick(event, index)} button id="apps" >
