...
class Messages extends Component {
    ...
    componentDidUpdate() {
        animateScroll.scrollToBottom({
            containerId: ["scrollable-mess", "scrollable-received"]
        })
        animateScroll.scrollToBottom({
            containerId: "scrollable-received"
        })
    }
            ...
            <div className="messages-container">
                ...
                <div className="mess">
                    ...
                    {this.state.content.length > 0 ?
                        <div className="mess-content" id="scrollable-mess">
                    ...
                    <div className="received-content" id="scrollable-received">
                        <div className="inbox">
