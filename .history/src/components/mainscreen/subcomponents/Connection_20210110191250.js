            ...
            <div className="connection-menu">
                ...
                <div className="setting">
                    ...
                    }
                    {
                        openConnectToHost ?
                            <div className="add">
                                <input autoComplete="off" type="text" className="input" placeholder="IP/DNS-Name_remoteHost " onChange={validateHostName} />
                                <input autoComplete="off" type="text" className="input" placeholder="Remote port socket " onChange={validateHostSocket} />
