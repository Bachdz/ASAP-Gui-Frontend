...
class Connection extends Component {
    ...
    doConnectToHost = () => {
        ...
        this.setState({ connectionAttempt: [...this.state.connectionAttempt, obj], showClientInfo: true })


    }

    doTerminateConnection = (ip, port) => {
        console.log("hehe" + ip, port);
    }
    doOpenConnection = () => {
                    ...
                    connectionAttempt.map((item, index) => {
                        return (
                            <div className="hosted-server">
                                ...
                                <CloseIcon id="close-icon" className="icon" onClick={this.doTerminateConnection.bind(item.ip, item.port)} />
                            </div>
                        )
                    })
