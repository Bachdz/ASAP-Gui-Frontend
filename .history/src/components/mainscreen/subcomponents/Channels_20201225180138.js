                                    ...
                                    this.state.channels.length === 0 ?
                                        ...
                                        this.state.channels.map((channel) => (
                                            <ListItem button id="channels" >
                                                <ListItemText classes={{ secondary: classes.listItemTextSecondary }} primary={channel.uri} secondary={channel.recipients.length > 0 ? "Recipients: " + channel.recipients : "Recipients: 0"} onClick={this.props.showMainScreen.bind(this, this.props.appName)} />
                                            </ListItem>
