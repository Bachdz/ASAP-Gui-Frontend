...
class Connection extends Component {
    ...
    doCancelConnection = (e) => {
        ...
        axios.post(url).then(res => {
            res.data === true ?
                this.setState({ alertopen: !this.state.alertopen, alertmsg: "Host succesfully cancelled", alerttype: "success", showHost: false, showAddConnection: !this.state.showAddConnection })
                :
    ...
    render() {
        const { showAddConnection, openAddConnection, activateAddConnection, alertmsg, alertopen, alerttype, openedConnection, showHostInfo } = this.state;
