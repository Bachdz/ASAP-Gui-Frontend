                            ...
                            <List>

                                {
                                    this.props.apps.map((app, index) => (
                                        <ListItem selected={selectedIndex === index} className={selectedIndex === index ? classes.setSelected : null} onClick={(event) => handleListItemClick(event, index).bind(this)} button id="apps" >
