...
class Channels extends Component {
    ...
    render() {
        ...
        const channelOnClick = (event, index, appName, channel, channelSelected) => {
            handleListItemClick(event, index);
            this.props.channelSelected(appName, channel, channelSelected);
        }
...

                                {
                                    this.state.channels.length === 0 ?
                                        ...
                                        this.state.channels.map((channel, index) => (
                                            <ListItem selected={selectedIndex === index && deselect === true} className={selectedIndex === index && deselect === true ? classes.setSelected : null} onClick={(event) => { channelOnClick(event, index, this.props.appName, channel, channelSelected) }} button id="channels" >
