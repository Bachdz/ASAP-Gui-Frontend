...
class Apps extends Component {
    ...
    render() {
        ...
        const handleListItemClick = (event, index) => {
            ...
            this.setState({ appName: this.props.apps[index].name, showChannel: !showChannel }, () => this.props.toggleMainScreen(this.state.showChannel, this.state.appName));
        };
                    ...
                    </div>
                    {
                        openAddApp ?
                            <div className="add">
                                ...
                                {
                                    activateAddApp ?
                                        <CheckIcon id="checkicon-activate" className="icon" onClick={this.props.doCreateApp.bind(this, newApp), this.setState({ openAddApp: false })} />
                                        :
