...
class Apps extends Component {
    ...
    render() {
        const { open, openAddApp, activateAddApp, newApp, selectedIndex, setSelectedIndex } = this.state;
                        ...
                        <List>

                            {
                                this.props.apps.map((app, index) => (
                                    <ListItem selected={selectedIndex === index} className={classes.setSelected} onClick={(event) => handleListItemClick(event, index)} button id="apps" >
