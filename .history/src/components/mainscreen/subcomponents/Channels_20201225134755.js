                                    ...
                                    this.state.channels.length === 0 ?
                                        ...
                                        this.state.channels.map((channel) => (
                                            <ListItem button id="channels" >
                                                <ListItemText classes={{ secondary: classes.listItemTextSecondary }} primary={channel.uri} secondary={"Recipients: " + channel.recipients.length > '0' ? channel.recipients : "0"} />
                                            </ListItem>
