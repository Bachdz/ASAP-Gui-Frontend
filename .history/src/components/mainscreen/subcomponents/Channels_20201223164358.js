                    ...
                    </div>
                    {
                        openAddChannel ?
                            <div className="addChannel">
                                <input autoComplete="off" type="text" id="addApp" name="channelname" className="input" placeholder="Enter channel url" onChange={validate} />
                                <input autoComplete="off" type="text" id="recipients" name="recipients" className="input" placeholder="Enter recipients" onChange={validate} />
