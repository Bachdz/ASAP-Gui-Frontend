...
class Connection extends Component {
    ...
    doSetOnlineMess = (e) => {
        urlActivate = 'http://localhost:8080/api/v1/asap/activatemess?peer=' + this.props.userName;
        urlDeactivate = 'http://localhost:8080/api/v1/asap/deactivatemess?peer=' + this.props.userName;
                ...
                <div className="setting">
                    ...
                    </p>
                    {
                        this.props.appSelected ?
                            <p className="toggle-setting">
                                <label class="switch">
                                    <input type="checkbox" onChange={this.doSetSendReceived} />
                                    <span class="slider round"></span>
