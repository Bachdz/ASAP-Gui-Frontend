...

                                {
                                    this.state.channels.length === 0 ?
                                        ...
                                        this.state.channels.map((channel, index) => (
                                            <ListItem selected={selectedIndex === index && deselect === true} className={selectedIndex === index && deselect === true ? classes.setSelected : null} onClick={() => { this.props.showMainScreen.bind(this, this.props.appName, channel, this.state.showMainScreen); }} button id="channels" >
