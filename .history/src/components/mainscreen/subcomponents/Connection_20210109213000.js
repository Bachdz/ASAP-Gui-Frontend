...
class Connection extends Component {
    ...
    doOpenConnection = () => {
        const url = 'http://localhost:8080/api/v1/asap/openconnection?port=' + this.state.newConnection + '&peer=' + this.props.userName;
        console.log(this.state.newConnection);
        ...
        return (
            <div className="connection-menu">
                ...
                <div className="hosted-server">
                    <PublicIcon id="icon" />  You are now hosting
                </div>
