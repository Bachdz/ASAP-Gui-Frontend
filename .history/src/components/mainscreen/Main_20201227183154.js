...
class Main extends Component {
    ...
    showMainScreen = (appName, channel, showMainScreen) => {
        console.log(appName, channel);

        let url = 'http://localhost:8080/api/v1/asap/messages?peer=' + this.state.username + '&storage=' + appName + '&uri=' + channel.uri;
        axios.get(url)
            .then(res => this.setState({ mainscreeninfo: res.data, showMainScreen: showMainScreen }))
    }
    ...
    render() {
        const { username, alertmsg, alertopen, alerttype, showMainScreen } = this.state;
                        ...
                        <section class="navigation">
                           ...
                           Welcome  <b> {this.state.username}</b>
                            ...
                            <div className="main-items">
                                ...
                                <Apps apps={this.state.apps} doCreateApp={this.doCreateApp} username={username} showMainScreen={this.showMainScreen} toggleMainScreen={this.toggleMainScreen} />
                        ...
                        <section class="main-screen">
                            {
                                showMainScreen ?
                                    ...
                                    <Messages content={this.state.mainscreeninfo} />
                                    :
                                    null
