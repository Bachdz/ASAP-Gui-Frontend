...
class Main extends Component {
    ...
    render() {
        const { username, open, openAddApp } = this.state;
                           ...
                           Welcome  <b> {this.state.username}</b>
                            ...
                            <List>
                                ...
                                </div>
                                {
                                    openAddApp ? 
                                    <div className="add">
                                <input type="text" id="addApp" name="appname" className="input" placeholder="Enter app name" oncChange={validate} />
                                <CheckIcon id="checkicon" className="icon" />
                                    </div>
                                    : null
                                }
