...
class Messages extends Component {
    ...
    getMessValue = (e) => {
        this.setState({ newMessValue: e.target.value })
    }

    createNewMess = (e) => {
        e.preventDefault();
        let obj = {
            mess: this.state.newMessValue,
        };
        ...
        axios.post(url, obj)
            .then(res => {
                res.data === null ?
                    ...
                    :
                    this.setState({ alertopen: !this.state.alertopen, alertmsg: "Message added successfully ", alerttype: "success", newMessValue: '' }, () => this.getChunk())
            })
    }
    render() {
        ...
        return (
            <div className="messages-container">
                <div className="big-title">
                    <div id="my-chunk"> My Chunks</div>
                    <div id="received-chunk">Received Chunks</div>
                </div>
                ...
                <div className="box">
                    <div class="message-box">
                        ...
                        <form onSubmit={this.createNewMess}>
                            <input type="text" value={this.state.newMessValue} class="message-input" placeholder="Type message..." onChange={(e) => this.setState({ newMessValue: e.target.value })}></input>
